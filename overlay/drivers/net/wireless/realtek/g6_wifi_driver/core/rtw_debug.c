...
void dump_drv_version(void *sel)
{
	...
	/* __DATE__/__TIME__ dropped: the kernel builds -Werror=date-time to keep
	 * builds reproducible. Build identity lives in the kernel version banner. */
	RTW_PRINT_SEL(sel, "build time: (reproducible build)\n");
}
